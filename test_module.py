...
class DataCleaningTestCase(unittest.TestCase):
    def test_data_cleaning(self):
        actual = int(time_series_visualizer.df2.count(numeric_only=True))
        expected = 1238
...
class BoxPlotTestCase(unittest.TestCase):
    ...
    def test_box_plot_labels(self):
        ...
        for label in self.ax2.get_xaxis().get_majorticklabels():
            actual.append(label.get_text())
        expected = ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December']
        self.assertEqual(actual, expected, "Expected box plot 2 secondary labels to be 'January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'")
        actual = []
        for label in self.ax1.get_yaxis().get_majorticklabels():
            actual.append(label.get_text())
        expected = ['0', '50000', '100000', '150000', '200000', '250000']
        self.assertEqual(actual, expected, "Expected box plot 1 secondary labels to be '0', '50000', '100000', '150000', '200000', '250000'")
